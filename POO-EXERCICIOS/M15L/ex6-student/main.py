...
Classes Concretas: Graduacao implementa as interfaces necessárias, outras classes concretas (Especializacao, Mestrado, Doutorado) continuam como estão.

Sistema Interativo: Sistema para adicionar e listar estudantes com papéis extras foi mantido.
'''