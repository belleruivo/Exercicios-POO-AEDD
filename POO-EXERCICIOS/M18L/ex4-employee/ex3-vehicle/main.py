                ...
                while True:
                    try:
                        ...
                        if 0 <= venda_id_veiculo < len(lista_veiculos) and 0 <= venda_id_cliente < len(lista_clientes):
                            veiculo_vendido = lista_veiculos[venda_id_veiculo]
                            cliente_comprador = lista_clientes[venda_id_cliente]
                            venda = Venda(cliente_comprador, veiculo_vendido)
                            print()
                            print(venda.registrar_venda())
                            lista_veiculos.pop(venda_id_veiculo)
                            break
                        else:
                            print("Opção inválida! Tente novamente.\n")
                    except ValueError:
