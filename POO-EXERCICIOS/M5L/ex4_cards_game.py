...
class CardsGame:
    ...
    def embaralhar_baralho(cls):
        random.shuffle(cls.baralho)  
        # acessar e modificar o atributo de classe 'baralho'
    ...
    def valor_carta(carta):
        ordem_valores = {'As': 14, 'Rei': 13, 'Dama': 12, 'Valete': 11, 
                         ...
                         '5': 5, '4': 4, '3': 3, '2': 2}
        valor = carta.split(' de ')[0].capitalize() 
    ...
    def jogar_rodada(self):
        ...
        for jogador in self.jogadores:
            ...
            # remove a carta jogada da mão do jogador e cria uma nova lista
        ...
        # acha jogador com a carta de maior valor, key=função de comparação
