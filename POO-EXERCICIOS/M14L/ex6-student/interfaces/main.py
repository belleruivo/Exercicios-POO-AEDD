...
'''
Versão com Mix-Ins
Classes Abstratas: Criamos a classe abstrata Student para representar estudantes.

Mix-Ins: Adicionamos funcionalidades extras (Líder e Clube) usando Mix-Ins (LiderMixin e ClubeMixin).

Herança Múltipla: As classes concretas de estudantes (Graduacao, Especializacao, etc.) herdam de Student e dos Mix-Ins.

Sistema Interativo: Implementamos um sistema para adicionar e listar estudantes com seus papéis extras.

Versão com Interfaces
Classes Abstratas: Criamos a classe abstrata Student para representar estudantes.

Interfaces: Adicionamos funcionalidades extras (Líder e Clube) usando interfaces (LiderInterface e ClubeInterface).

Herança Múltipla: As classes concretas de estudantes (Graduacao, Especializacao, etc.) herdam de Student e implementam as interfaces.
